...
class ConvBlock(nn.Module):
    def __init__(self, out_channels):
        ...
        self.shallownet = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=40, kernel_size=(1, 60), stride=(1, 2), padding=(0, 28), padding_mode='replicate'),
            nn.Conv2d(in_channels=40, out_channels=40, kernel_size=(22, 1), stride=(1, 1)),
            nn.BatchNorm2d(40),
            nn.ELU(),
            nn.AvgPool2d(kernel_size=(1, 200), stride=(1, 15))
    ...
    def forward(self, X):  # X.shape = (batch_size, 1, channels, samplepoints)
        # out.shape = (batch_size, 40, 1, samplepoints'(20))
