...
class ConvBlock(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.shallownet = nn.Sequential(
            nn.Conv2d(in_channels=in_channels, out_channels=40, kernel_size=(1, 60), stride=(1, 2), padding=(0, 28), padding_mode='replicate'),
            nn.Conv2d(in_channels=40, out_channels=40, kernel_size=(22, 1), stride=(1, 1)),
            nn.BatchNorm2d(40),
            nn.ELU(),
            nn.AvgPool2d(kernel_size=(1, 300), stride=(1, 10))
    ...
    def forward(self, X):  # X.shape = (batch_size, 1, channels, samplepoints)
        # 这里的128是num_hiddens
        # out.shape = (batch_size, 128, channels, samplepoints'(40))
...
class EEGCNN_notransformer(nn.Module):
    def __init__(self,
                 channels,
                 query_size=40,
                 key_size=40,
                 ...
                 out_channels=40,
                 num_class=4):
        super(EEGCNN_notransformer, self).__init__()
